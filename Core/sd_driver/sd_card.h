...
typedef struct {
    ...
    uint32_t ss_pin;                   // Slave select for this SD card

    bool use_card_detect;
    GPIO_TypeDef *card_detect_port;
    uint32_t card_detect_pin;    // Card detect
    uint32_t card_detected_true;  // Varies with card socket
